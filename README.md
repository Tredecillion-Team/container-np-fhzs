...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-np-fhzs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-np-fhzs.containers.anotherwebservice.com/
...
```
git clone git@github.com:Tredecillion-Team/container-np-fhzs.git
cd container-np-fhzs
```
...
```
docker attach container-np-fhzs
```
